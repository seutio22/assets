...
const EnderecoFornecedorForm = ({ enderecoId, fornecedorId, onSuccess, onCancel }: EnderecoFornecedorFormProps) => {
  ...
  const fetchEndereco = async () => {
    try {
      const response = await api.get(`/enderecos-fornecedores/${enderecoId}`)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (enderecoId) {
        await api.put(`/enderecos-fornecedores/${enderecoId}`, data)
      } else {
        await api.post('/enderecos-fornecedores', data)
      }
      onSuccess()
    } catch (err: any) {
...
export default EnderecoFornecedorForm
