...
interface EnderecoSubEstipulanteFormProps {
  enderecoId?: string
...
const EnderecoSubEstipulanteForm = ({ enderecoId, subEstipulanteId, onSuccess, onCancel }: EnderecoSubEstipulanteFormProps) => {
  ...
  const fetchEndereco = async () => {
    try {
      const response = await api.get(`/enderecos-sub-estipulante/${enderecoId}`)
      const endereco = response.data
      setFormData({
        subEstipulanteId: endereco.subEstipulanteId,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = {
        ...formData,
        subEstipulanteId: subEstipulanteId || formData.subEstipulanteId,
      ...
      if (enderecoId) {
        await api.put(`/enderecos-sub-estipulante/${enderecoId}`, data)
      } else {
        await api.post('/enderecos-sub-estipulante', data)
      }
      onSuccess()
    } catch (err: any) {
...
export default EnderecoSubEstipulanteForm
